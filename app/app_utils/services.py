...
MEMORY_BANK_ID = "7151869590136422400"
...
def get_memory_service():
    ...
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-03-a4d830cde502")
    location = os.environ.get("GOOGLE_CLOUD_LOCATION", "us-central1")
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID", MEMORY_BANK_ID)
